...
export const SETTING_DEFS: Record<string, SettingDef> = {
  ...
  context_budget_small: { kind: "integer", min: 0, max: 32000, desc: "Budget prompt système — petit modèle (0 = auto ≈4k)" },
  context_budget_medium: { kind: "integer", min: 0, max: 32000, desc: "Budget prompt système — modèle moyen (0 = auto ≈8k)" },
  context_budget_large: { kind: "integer", min: 0, max: 32000, desc: "Budget prompt système — grand modèle (0 = auto ≈12k)" },
...
export const CONVERSATION_SETTING_DEFS: Record<string, SettingDef> = {
  ...
  behavior: { kind: "enum", values: ["reactif", "equilibre", "cinematique"], desc: "Comportement RP (partie)" },
  context_mode: { kind: "enum", values: ["simple", "avance"], desc: "Mode de contexte (partie)" },
  response_length: { kind: "enum", values: ["courte", "moyenne", "longue"], desc: "Longueur de réponse (partie)" },
  scene_focus: { kind: "enum", values: ["", "explorer", "conversation", "romance", "adulte", "combat", "enquete", "tranche_de_vie", "personnage", "ooc"], desc: "Focus de scène (partie, vide = auto)" },
  auto_npcs: { kind: "boolean", desc: "Suggestion PNJ auto (partie)" },
  auto_relations: { kind: "boolean", desc: "Relations auto (partie)" },
  ...
  // server-managed
  intent_history: { kind: "array", desc: "Historique d'intention (partie, interne)" },
